...
pacstrap /mnt iptables-nft nvidia nvidia-utils nvidia-settings xorg git make xdg-user-dirs xdg-utils lightdm lightdm-slick-greeter
...
for service in reflector.timer snapper-timeline.timer snapper-cleanup.timer btrfs-scrub@-.timer btrfs-scrub@home.timer btrfs-scrub@var-log.timer btrfs-scrub@\\x2esnapshots.timer grub-btrfs.path systemd-oomd lightdm
do
